...
void ObjectManager::loadMonsterObjs()
{
	...
	//Demon Dmon
	Object* Demon1 = new Object("src/meshes/Enemies/GhostBoss1.v", "src/textures/Grim_reaper.bmp");
	Object* Demon2 = new Object("src/meshes/Enemies/GhostBoss4.v", "src/textures/Grim_reaper.bmp");
