...
bool Audio::playSound()
{
	// test code
	//Loading of the WAVE file
	FILE *fp = NULL;                                                            //Create FILE pointer for the WAVE file
	fp = fopen("../Audio/witcher_omnious.wav", "rb");                                            //Open the WAVE file
	...
	fread(&size, sizeof(unsigned long), 1, fp);                                           //Continue to read the file
	...
	fread(&dataSize, sizeof(unsigned long), 1, fp);                                        //The size of the sound data is read
	...
	cout << fread(buf, sizeof(char), dataSize, fp) << " bytes loaded\n";           //Read the sound data and display the 
